  ...
  <div class="grid grid-cols-2 gap-2 sm:gap-3 lg:grid-cols-4">
    ...
    <div class="group rounded-xl border border-border bg-surface p-3 shadow-sm transition-theme hover:shadow-md hover:border-warning/30 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0">
          <p class="text-[11px] font-medium uppercase tracking-wider text-text-muted sm:text-xs">Gastos</p>
          <p class="text-lg font-bold text-text tabular-nums sm:text-xl lg:text-2xl">{{ formatUSD(expenseTotal) }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="group rounded-xl border border-border bg-surface p-3 shadow-sm transition-theme hover:shadow-md hover:border-info/30 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0">
          <p class="text-[11px] font-medium uppercase tracking-wider text-text-muted sm:text-xs">Ganancia Neta</p>
          <p class="text-lg font-bold text-text tabular-nums sm:text-xl lg:text-2xl">{{ formatUSD(netTotal) }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="group rounded-xl border border-border bg-surface p-3 shadow-sm transition-theme hover:shadow-md hover:border-primary/30 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0">
          <p class="text-[11px] font-medium uppercase tracking-wider text-text-muted sm:text-xs">Margen</p>
          <p class="text-lg font-bold text-text tabular-nums sm:text-xl lg:text-2xl">{{ formatPercentage(margin) }}</p>
        </div>
      </div>
    </div>
  </div>
