    ...
    <div class="group rounded-xl border border-border bg-surface p-2.5 shadow-sm transition-theme hover:shadow-md hover:border-success/30 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          ...
          <p class="text-lg font-bold text-text tabular-nums sm:text-2xl">{{ formatUSD(incomeTotal) }}</p>
    ...
    <div class="group rounded-xl border border-border bg-surface p-2.5 shadow-sm transition-theme hover:shadow-md hover:border-warning/30 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          ...
          <p class="text-lg font-bold text-text tabular-nums sm:text-2xl">{{ formatUSD(expenseTotal) }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="group rounded-xl border border-border bg-surface p-2.5 shadow-sm transition-theme hover:shadow-md hover:border-info/30 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          ...
          <p class="text-lg font-bold text-text tabular-nums sm:text-2xl">{{ formatUSD(netTotal) }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="group rounded-xl border border-border bg-surface p-2.5 shadow-sm transition-theme hover:shadow-md hover:border-primary/30 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          ...
          <p class="text-lg font-bold text-text tabular-nums sm:text-2xl">{{ formatPercentage(margin) }}</p>
        </div>
      </div>
    </div>
