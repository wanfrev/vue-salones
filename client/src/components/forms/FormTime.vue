  ...
  <div class="space-y-1.5">
    ...
    <div class="flex items-center gap-2">
      <select
        ...
        @change="onHourChange"
        :disabled="disabled"
        class="rounded-xl border bg-surface text-text outline-none transition-theme focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-bg-secondary pl-3 pr-7 py-2.5 text-sm"
      ...
      <button
        ...
        :disabled="disabled"
        @click="toggleAmPm"
        class="rounded-xl border bg-surface text-sm font-semibold px-3 py-2.5 outline-none transition-theme hover:bg-bg-secondary disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-bg-secondary min-w-[52px] text-center"
        :class="[
