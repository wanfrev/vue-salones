...
// Mientras tanto, este archivo cubre lo que el client usa hoy.
...
// Estructura mínima compatible con el genérico Database<...> de supabase-js.
// Cuando generes los tipos automáticos, sobreescribe este archivo.
...
export interface Database {
  public: {
    Tables: {
      ...
      employee_services: TableShape<{ employee_id: string; service_id: string }>
